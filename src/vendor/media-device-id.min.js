/* Under MIT License by Mazuh. Original source code at: https://github.com/Mazuh/media-device-id */
...
!(function(t) {
  ...
  function(t, r, e) {
    "use strict";
    e.r(r),
      e.d(r, "assureMediaInputId", function() {
        return u;
      });
    var n = e(0),
      o = e.n(n),
    ...
    function c() {
      return (c = a()(
        o.a.mark(function t(r, e, n) {
          var i, a, u, c, f, s, l, h, p, v, d;
          return o.a.wrap(
            function(t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    return (
                      (i = function(t) {
                        return t.kind.indexOf("input") > -1;
                      }),
                      (t.next = 3),
                      navigator.mediaDevices
                        .enumerateDevices()
                        .then(function(t) {
                          return { ok: t.filter(i) };
                        })
                        .catch(function(t) {
                          return { err: t };
                        })
                  ...
                  case 23:
                    return t.abrupt("return", p ? p.deviceId : d.deviceId);
                  case 24:
                  case "end":
                    return t.stop();
                }
    ...
    void 0 !== window && (window.assureMediaInputId = u);
  },
  function(t, r, e) {
    var n =
        (function() {
    ...
    if (((n.regeneratorRuntime = void 0), (t.exports = e(4)), o))
  ...
  function(t, r) {
    !(function(r) {
      ...
      if (s) f && (t.exports = s);
        ...
        (s = r.regeneratorRuntime = f ? t.exports : {}).wrap = b;
        ...
        var w = (O.prototype = L.prototype = Object.create(y));
